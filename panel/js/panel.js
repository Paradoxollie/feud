...
var CurrentRound = 1;
	...
	function start_game(){	
		...
		var interval = setInterval(function() {
			...
			if (counter <= 0) {
				...
				game.document.getElementById("counter").innerHTML = "Northrop Grumman";
	...
	function GetAnswers(answers, currentQnumber, totalQnumber){
		...
		for (i = 0; i < answers.length; i++) { 
			...
			cell3.innerHTML = (answers[i][1] * CurrentRound); //(answers[i][1] * round);	//double or triple points	//roundpoints
